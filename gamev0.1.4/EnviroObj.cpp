...
it is recommended to use print the world coordinates for debugging  
...
void EnviroObj::render(const worldCoord& pos)const//render a billboarded object in a specified location
{
